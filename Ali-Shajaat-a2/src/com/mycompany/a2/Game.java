...
public class Game extends Form
{
	...
	private void setUp() 
	{
		CustomCommand menu = new CustomCommand(gw);
		...
		Buttons accelerate = new Buttons ("Accelerate");
		...
		Buttons changeStrategies = new Buttons ("Change Strategies");
		...
		Buttons brake = new Buttons ("Brake");
		...
		Buttons right = new Buttons ("Right");
